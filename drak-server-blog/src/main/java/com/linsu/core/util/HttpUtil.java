...
import com.linsu.core.xss.XSSHttpServletRequestWrapper;
...
public class HttpUtil {
    ...
    public static void main(String args[]){
        System.out.println("收到的内容");
        System.out.println(sendGet("https://zhuanlan.zhihu.com/p/44195679", new HashMap<>()));
    }
